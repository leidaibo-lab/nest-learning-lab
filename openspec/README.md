...
当前稳定规格包括 `task-management`、`task-validation`、`task-persistence`、`task-status`、`user-auth`、`project-membership`、`request-observability` 和 `service-health`；已完成变更均已归档到 `changes/archive/`。下一项计划变更将进入异步与实时场景。
